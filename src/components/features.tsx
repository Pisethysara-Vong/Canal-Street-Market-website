  ...
  return (
    <div>
        ...
        <div className="md:grid grid-cols-2 flex flex-col md:gap-12 gap-10 md:mt-16 md:mb-8 mb-6 mt-8 border-2">
            <div className='border-2 border-green-400 flex flex-col md:gap-4 gap-2'>
        ...
        <div className="w-full border-2 border-black md:text-[16px] text-[15px] py-4 text-center hover:bg-black hover:text-white duration-250 ease-out cursor-pointer options-text">
