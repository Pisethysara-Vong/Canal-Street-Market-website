  ...
  return (
    <div>
        ...
        <div className="md:grid grid-cols-2 flex flex-col md:gap-12 gap-10 md:mt-16 md:mb-8 mb-6 mt-8">
            <div onClick={() => handleClick("https://canalstreet.market/community/feature/amdc")} className='flex flex-col md:gap-4 gap-2 cursor-pointer'>
            ...
            <div onClick={() => handleClick("https://canalstreet.market/community/feature/joe-rong")} className='flex flex-col md:gap-4 gap-2 cursor-pointer'>
                <div className='md:h-120 w-full'>
            ...
            <div onClick={() => handleClick("https://canalstreet.market/community/feature/csm-community/")} className='flex flex-col md:gap-4 gap-2 cursor-pointer'>
                <div className='md:h-120 w-full'>
            ...
            <div onClick={() => handleClick("https://canalstreet.market/community/feature/csm-community---izakaya/")} className='flex flex-col md:gap-4 gap-2 cursor-pointer'>
                <div className='md:h-120 w-full'>
