...
const FoodSelection = () => {
    ...
    return (
        <div onClick={() => hoveredIndex !== null && handleClick(foodItems[hoveredIndex].url)} className="relative md:grid grid-cols-3 flex flex-col md:gap-24 gap-4 lg:mt-26 lg:mb-26 mb-18 mt-18 z-0">
